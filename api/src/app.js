...
const corsOptions = {
  ...
  origin: 'https://llaveparalasnaciones.com',
  //origin: 'https://llave-para-las-naciones.vercel.app',
...
server.use((req, res, next) => {
  //res.header('Access-Control-Allow-Origin', 'https://llave-para-las-naciones.vercel.app');
  res.header('Access-Control-Allow-Origin', 'https://llaveparalasnaciones.com');
